...
public class FireCommonMode implements ActionListener{
	...
	final int row=7;//You can change this for length of the map
	final int col=7;//You can change this for width of the map
	final int shipNum=1;
	int length=3;
	...
	public static void main(String[] args) {
		FireCommonMode fire=new FireCommonMode();
